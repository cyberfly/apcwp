            ...
            <div class="inside">
                ...
                foreach($write_panel['options'] as $meta_box):
					...
					if($meta_box['type'] == 'image'){ ?>
						...
						<div class="themify_field_row clearfix featimgcontrol <?php echo esc_attr( $toggle_class ); ?>" <?php echo $ext_attr; ?>>
					...
					///////////////////////////////////////////
						...
						<input type="hidden" name="<?php echo esc_attr( $meta_box['name'] . '_noncename' ); ?>" id="<?php echo esc_attr( $meta_box['name'] . '_noncename' ); ?>" value="<?php echo wp_create_nonce( plugin_basename(__FILE__) ); ?>" />
                        <div class="themify_field_row clearfix <?php echo esc_attr( $toggle_class ); ?>" <?php echo $ext_attr; ?>>
					...
					///////////////////////////////////////////
						...
						<input type="hidden" name="<?php echo esc_attr( $meta_box['name'] . '_noncename' ); ?>" id="<?php echo esc_attr( $meta_box['name'] . '_noncename' ); ?>" value="<?php echo wp_create_nonce( plugin_basename(__FILE__) ); ?>" />
						<div class="custom-post-meta-group themify_field_row clearfix <?php echo esc_attr( $toggle_class ); ?>" <?php echo $ext_attr; ?>>
						...
						foreach ($meta_box['meta']['fields'] as $field) {
							if ( is_callable( 'themify_meta_field_'.$field['type'] ) ) {
								...
								if ( ! ( $field === end( $meta_box['meta']['fields'] ) ) ) {
									if ( isset( $meta_box['meta']['separator'] ) ) {
							...
							<div class="themify_field">
								...
								foreach($sidebars as $sidebar => $val){
									if($sidebar != 'wp_inactive_widgets' && $sidebar != 'array_version' && strpos(strtolower($wp_registered_sidebars[$sidebar]['name']),'sidebar') !== false){
										...
										?>
										<input type="checkbox" name="<?php echo esc_attr( $meta_box['name'] ); ?>[<?php echo $wp_registered_sidebars[$sidebar]['name']; ?>]" <?php echo $checked; ?> /> <?php echo $wp_registered_sidebars[$sidebar]['name']; ?><br />
									<?php
									}
								}
								?>
	...
	if ( is_multisite() && !is_upload_space_available() ) {
		...
		if( '' != $args['fallback'] )
			...
			<?php } ?>
				...
				?>
				<div class="plupload-upload-uic hide-if-no-js <?php echo esc_attr( $classes ); ?>" <?php echo $datas; ?> id="<?php echo esc_attr( $id ); ?>plupload-upload-ui">
...
if ( ! function_exists( 'themify_zoom_icon' ) ) {
	...
	function themify_zoom_icon( $echo = true ) {
		$icon = apply_filters( 'themify_zoom_icon', themify_check('lightbox_icon')? '<span class="zoom"></span>': '' );
		if ( $echo )
			echo $icon;
		return $icon;
	}
